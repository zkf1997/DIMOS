...
You can also choose to manually specify the path consisting of waypoints in the script.
* Generation:
  ```
...
* Visualization:
  ...
  Results generated by other demos can be visualized in the same way.
