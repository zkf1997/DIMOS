...
parser.add_argument('--sdf_path', type=str, default='', help='interaction object sdf grid path')
parser.add_argument('--mesh_path', type=str, default='', help='interaction object mesh path')
...
parser.add_argument('--target_body_path', type=str, default=None, help='file path of goal interaction body')
