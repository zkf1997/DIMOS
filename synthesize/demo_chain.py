...
if __name__ == '__main__':
    ...
    for seq_id in range(seq_num):
        scene_dir = Path('./data/test_room')
        target_interaction_path = 'data/test_room/chair_sit on/goal.pkl'
        action = 'sit'
        obj_category = 'chair'
        obj_id = 0
        ...
        #           "--visualize 0 --use_zero_pose 1 --use_zero_shape 1".format(seq_id, scene_path, scene_name, navmesh_tight_path, floor_height, wpath_path, path_name)
        # print(command)
        # os.system(command)
        ...
        target_interaction_path = 'data/test_room/sofa_sit on/goal.pkl'
        action = 'sit'
        obj_category = 'sofa'
        obj_id = 0
